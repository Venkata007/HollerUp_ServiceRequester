...
public protocol PageIndicatorView: class {
    ...
    /// Current page tintColor
    var currentPageTintColor1: UIColor { get set }
    
    ///  tintColor
    var tintColor1: UIColor { get set }
}

extension UIPageControl: PageIndicatorView {
    public var currentPageTintColor1: UIColor {
        get {
...
public class LabelPageIndicator: UILabel, PageIndicatorView {
    ...
    public var tintColor1: UIColor = .whiteColor {
        didSet {
            updateLabel()
        }
    }
    
    public var currentPageTintColor1: UIColor = .themeColor {
        didSet {
            updateLabel()
        }
    }
