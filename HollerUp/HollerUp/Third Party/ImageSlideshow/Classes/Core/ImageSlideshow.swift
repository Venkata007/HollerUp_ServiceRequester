 ...
 */
@objc protocol ImageSlideshowDelegate{
    @objc func pageControllerPageChanged(_ viewCon:ImageSlideshow, page:Int)
}
...
extension ImageSlideshow: UIScrollViewDelegate {
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if let delegate = self.delegate{
            delegate.pageControllerPageChanged(self, page: (pageIndicator?.page)!)
        }
    }
}
