...
open class SideMenuTransition: UIPercentDrivenInteractiveTransition {
    ...
    @objc internal static let singleton = SideMenuTransition()
    @objc internal static var presentDirection: UIRectEdge = .left;
    @objc internal static weak var tapView: UIView? {
        didSet {
    ...
    @objc internal static weak var statusBarView: UIView? {
        didSet {
    ...
    @objc internal class func presentMenuStart(forSize size: CGSize = SideMenuManager.appScreenRect.size) {
